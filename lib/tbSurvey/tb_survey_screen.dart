...
import 'package:asha_pay/tbSurvey/tb_survey_controller.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

import '../common/widget/loaders.dart';

class TBSurveyScreen extends StatelessWidget {
  ...
  final TBSurveyController controller =
  Get.put(TBSurveyController());
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: GetBuilder<TBSurveyController>(
        id: "tb_survey",
        builder: (controller) {
    ...
    return Container(
      ...
      child: const Column(
        ...
        children: [
          ...
          SizedBox(height: 8),
          Text(
            "परिवार में टीबी रोगी की जानकारी दर्ज करें",
            style: TextStyle(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const Text(
            "क्या परिवार में कोई टीबी रोगी है ?",
            style: TextStyle(
              fontSize: 16,
